...
function init_charts() {
    if (console.log("run_charts  typeof [" + typeof Chart + "]"), "undefined" != typeof Chart) {
            ...
            var lineChart = new Chart(e, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        {
                            label: 'SELIC',
                            data: [1500, 1550, 1600, 1650, 1700, 1750, 1800],
                        ...
                        {
                            label: 'LCI',
                            data: [1800, 1850, 1900, 1950, 2000, 2050, 2100],
                        ...
                        {
                            label: 'Renda Fixa',
                            data: [2000, 2050, 2100, 2150, 2200, 2250, 2300],
                        ...
                        {
                            label: 'Mazzotini',
                            data: [2300, 2350, 2400, 2450, 2500, 2550, 2600],
        ...
        if ($("#mybarChart").length) e = document.getElementById("mybarChart"), new Chart(e, {
            type: "bar",
            data: {
                labels: ['Poupança', 'SELIC', 'CDB', 'LCI', 'Renda Fixa', 'Mazzotini'],
                datasets: [{
                    label: 'Rendimentos',
                    data: [1200, 1500, 1000, 1800, 2000, 2300],
                    backgroundColor: [
                        'rgba(255, 99, 132, 0.2)',
                        'rgba(54, 162, 235, 0.2)',
                        'rgba(255, 206, 86, 0.2)',
        ...
        if ($("#canvasRadarOLD").length) e = document.getElementById("canvasRadar"), a = {
        ...
        var radarChart = new Chart(ctx, {
            ...
            options: {
                title: {
                    display: true,
                    text: 'Comparativo de Investimentos - Radar'
                },
                scale: {
                    ticks: {
                        beginAtZero: true,
        ...
        if ($("#pieChartOLD").length) e = document.getElementById("pieChart"), a = {
            datasets: [{
                data: [120, 50, 140, 180, 100],
                backgroundColor: ["#455C73", "#9B59B6", "#BDC3C7", "#26B99A", "#3498DB"],
                label: "My dataset"
        ...
        var myPieChart = new Chart(ctx, {
            ...
            options: {
                title: {
                    display: true,
                    text: 'Comparativo de Investimentos - Pizza'
                },
                responsive: true,
